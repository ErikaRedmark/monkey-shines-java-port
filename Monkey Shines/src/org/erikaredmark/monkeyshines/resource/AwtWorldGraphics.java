...
public class AwtWorldGraphics {
	...
	public final int backgroundCount;
	...
	/**
	 * Returns the number of unique backgrounds (standards ones, not ones generated by
	 * patterns) in this object.
	 * @return
	 */
	...
	/**
	 * Returns the number of unique patterned backgrounds.
	 * @return
	 */
